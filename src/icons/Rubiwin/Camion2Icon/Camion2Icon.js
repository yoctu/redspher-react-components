...
function Camion2Icon(props) {
  return (
    <SvgIcon {...props} htmlColor='transparent' viewBox='0 0 20 20'>
      <path d='M2 10.9V5H11.84V10.9' stroke='#171F46' />
      <path
        d='M13.5 14.27H11.84V6.44H15.49L17.78 10.22V14.27H16.46'
        stroke='#171F46'
      />
      <path d='M2 10.9V14.27H3.59' stroke='#171F46' />
      <path d='M6.69995 14.27H11.84V10.9' stroke='#171F46' />
      <path d='M13.65 6.44V10.61H17.78' stroke='#171F46' />
      <path

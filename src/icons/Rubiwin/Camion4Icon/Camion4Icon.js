...
function Camion4Icon(props) {
  return (
    <SvgIcon {...props} htmlColor='transparent' viewBox='0 0 20 20'>
      <path d='M1 12V4H15V6.5' stroke='#171F46' />
      <path d='M19 14.5751V10.4063L17.5 6H15V12.5' stroke='#171F46' />
      <path d='M15 12.5H7H1V14.5751H2' stroke='#171F46' />
      <path d='M5 14.5751H6' stroke='#171F46' />
      <path d='M9.09424 14.5751H11.5' stroke='#171F46' />
      <path d='M15.136 14.5751H16.0129' stroke='#171F46' />
      <path d='M15 10H18.5086' stroke='#171F46' />
      <path

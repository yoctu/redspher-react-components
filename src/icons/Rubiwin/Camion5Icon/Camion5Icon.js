...
function Camion5Icon(props) {
  return (
    <SvgIcon htmlColor='transparent' viewBox='0 0 20 20'>
      ...
      />
      <path
        d='M14.9501 14.15C15.6902 14.15 16.2901 13.55 16.2901 12.81C16.2901 12.0699 15.6902 11.47 14.9501 11.47C14.21 11.47 13.6101 12.0699 13.6101 12.81C13.6101 13.55 14.21 14.15 14.9501 14.15Z'
        stroke={
          props.primarycolor ? props.primarycolor : themeConstants.grey.main
        }
      />

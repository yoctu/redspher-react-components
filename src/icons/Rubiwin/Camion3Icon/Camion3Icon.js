...
function Camion3Icon(props) {
  return (
    <SvgIcon {...props} htmlColor='transparent' viewBox='0 0 20 20'>
      <path d='M12.4156 4V11.158H1V4H12.4156Z' stroke='#171F46' />
      <path
        d='M18.0001 14.6422H19.0001V10.447L16.9514 6.52429H13.7V14.0634'
        stroke='#171F46'
      />
      <path d='M12.4156 13.0571V11.158H1V14.6421H2.41676' stroke='#171F46' />
      <path d='M5.5 14.6422H10.5' stroke='#171F46' />
      <path d='M13.5 14.6422H15.2695' stroke='#171F46' />
      <path d='M15.3103 6.52429V10.8617H19' stroke='#171F46' />
      <path

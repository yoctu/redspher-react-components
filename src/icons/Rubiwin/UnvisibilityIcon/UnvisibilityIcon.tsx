  ...
  return (
    <SvgIcon {...props} htmlColor='transparent' viewBox='0 0 20 20'>
      <path
        ...
        fill={secondarycolor || themeConstants.tertiary.main}
        strokeOpacity={0}
      />
      <path
        ...
        fill={primarycolor || themeConstants.primary.dark}
        strokeOpacity={0}
      />
      <rect
        x='1.60669'
        ...
        height='22.4234'
        rx='0.5'
        transform='rotate(-45 1.60669 2.31378)'
        fill={tertiarycolor || themeConstants.grey.main}
        strokeOpacity={0}
      />
    </SvgIcon>
  )

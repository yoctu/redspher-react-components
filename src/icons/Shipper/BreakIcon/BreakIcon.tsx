  ...
  return (
    <SvgIcon htmlColor='transparent' viewBox='0 0 20 20'>
      ...
      <path
        ...
        stroke={
          props.secondary ? props.secondary : themeConstants.secondary.main
        }
        strokeLinecap='round'
        strokeLinejoin='round'
      />
